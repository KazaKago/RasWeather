...
import rasweather.presentation.controller.ICycleFxController
import rasweather.presentation.controller.SceneInfo
 ...
 */
abstract class CycleFxApplication() : javafx.application.Application(), rasweather.ICycleFxApplication {

    private var currentSceneInfo: SceneInfo? = null
    private val sceneBackStack = java.util.ArrayDeque<SceneInfo>()
    private lateinit var primaryStage: javafx.stage.Stage
